...
const AllergyCard: React.FC<AllergyCardProps> = ({ languageCode, selectedAllergens }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full min-h-screen bg-gray-50 dark:bg-gray-900 p-4 sm:p-8">
      ...
      <div 
        ref={cardRef} 
        className="bg-white shadow-2xl rounded-3xl p-8 sm:p-12 w-full max-w-md aspect-[3/4] flex flex-col items-center justify-center text-center border-4 border-red-600 print:shadow-none print:border-red-600 print:m-0 print:rounded-none"
      >
        <h1 className="text-4xl sm:text-5xl font-black leading-tight mb-8 text-red-600 uppercase tracking-tighter">
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-8">
          {translatedAllergenList.map((allergen, index) => (
            <span
              key={index}
              className="bg-red-600 text-white px-5 py-2 rounded-full text-xl font-black uppercase"
            >
              {allergen}
            </span>
          ))}
        ...
        <p className="text-xl sm:text-2xl font-bold text-gray-800 mb-4 leading-tight">
        ...
        {allergensWithImages.length > 0 && (
          <div className="relative w-full max-w-[280px] aspect-square mx-auto mt-8">
