...
const StepHeader: React.FC<StepHeaderProps> = ({ title, description, icon: Icon }) => {
  ...
  return (
    <div className="w-full px-4 flex flex-col items-center text-center">
      {Icon && (
        <div className="bg-red-100 dark:bg-red-900/30 p-3 sm:p-5 rounded-full shrink-0 mb-2">
      ...
      <div className="w-full">
        ...
        <div className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-md mx-auto leading-relaxed mt-1">
