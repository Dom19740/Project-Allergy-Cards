// Plain data, no framework/dictionary imports - safe to bundle both by the
// client (Vite) and the Nitro server routes, which use a separate bundler
// and shouldn't have to pull in the large allergen/UI dictionaries just to
