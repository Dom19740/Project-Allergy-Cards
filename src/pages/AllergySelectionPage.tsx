      ...
      <div className="flex flex-col flex-grow w-full max-w-2xl mx-auto px-4 pt-[126px] overflow-hidden">
        ...
        <div className="w-full flex justify-between items-center mt-auto mb-[50px] gap-4 shrink-0">
          <Button
            variant="outline"
            onClick={() => navigate(-1)}
            className="flex items-center justify-center py-6 px-8 text-lg h-auto min-w-[140px] rounded-xl bg-white dark:bg-transparent border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-gray-100"
          >
          ...
          <Button
            ...
            variant="primary"
            className="py-6 px-8 text-lg h-auto min-w-[140px] rounded-xl shadow-lg transition-transform active:scale-95 flex items-center"
          >
            Continue
