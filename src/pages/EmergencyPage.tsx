    ...
    <div className="flex flex-col w-full h-screen bg-white overflow-hidden">
      <div ref={cardRef} className="flex-1 w-full flex flex-col items-center justify-start text-center overflow-hidden p-4 sm:p-6 md:p-8 pt-[calc(1rem+env(safe-area-inset-top))] bg-white border-none">
        ...
        <div className="mt-auto w-full max-w-md pt-6">
          <a href={`tel:${emergencyNumber}`} className="flex items-center justify-center gap-3 sm:gap-4 w-full py-4 sm:py-6 px-6 bg-red-600 hover:bg-red-700 text-white rounded-2xl text-2xl sm:text-3xl font-black shadow-xl transition-transform active:scale-95 text-center">
            <Phone className="h-8 w-8 sm:h-10 sm:w-10 fill-current shrink-0" />
            <span className="leading-tight">{translatedText.dialText} {emergencyNumber}</span>
          </a>
        </div>
      </div>
