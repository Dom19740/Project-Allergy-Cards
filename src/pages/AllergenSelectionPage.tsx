            ...
            <div className="w-full">
              <div className="flex space-x-2">
                <Input
                  ...
                  className="flex-grow ml-[10px] px-4 py-2 text-sm sm:text-base bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg shadow-sm text-gray-800 dark:text-gray-200 h-9"
                  onKeyPress={(e) => {
                    if (e.key === 'Enter') {
