...
const AllergyCard: React.FC<AllergyCardProps> = ({ languageCode, selectedAllergens }) => {
    ...
    const translateAllContent = async () => {
      ...
      try {
        ...
        const [alert, allergicTo, careful, thankYou, langName, theyMakeMeSick] = await Promise.all([
          ...
          translateText("I am allergic to:", languageCode),
  ...
  return (
    <div className="flex flex-col items-center justify-around w-full bg-white text-foreground p-4 sm:p-8 text-center relative overflow-hidden pb-20 flex-grow">
      ...
      <h1 className="relative z-10 text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight mb-8 text-red-700 dark:text-red-400">
        {title}
      </h1>
      
      <p className="relative z-10 text-2xl sm:text-3xl md:text-4xl font-semibold leading-relaxed text-gray-800 dark:text-gray-200">
      ...
      {allergensWithImages.length > 0 && (
        <div className="relative z-10 w-full max-w-[90vw] max-h-[35vh] aspect-square mx-auto my-4">
      ...
      <div className="relative z-10 flex justify-center gap-4 w-full mt-4">
        <Button
          onClick={handleDownload}
          disabled={isDownloading}
          className="bg-blue-600 text-white hover:bg-blue-700 px-6 py-3 rounded-lg text-lg font-semibold shadow-lg flex items-center space-x-2"
        >
        ...
        <Button
          onClick={handleShare}
          disabled={isSharing}
          className="bg-green-600 text-white hover:bg-green-700 px-6 py-3 rounded-lg text-lg font-semibold shadow-lg flex items-center space-x-2"
        >
