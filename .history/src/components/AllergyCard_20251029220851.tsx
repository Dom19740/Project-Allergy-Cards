  ...
  const handleShare = async () => {
    ...
    try {
      ...
      if (navigator.share && navigator.canShare({ files: [file] })) {
        ...
        toast.info("Sharing not supported, image downloaded instead.", { id: loadingToastId });
      }
    } catch (error) {
  ...
  return (
    ...
    >
      ...
      <Button 
        onClick={handleShare} 
        disabled={isSharing}
        className="mt-8 bg-green-600 text-white hover:bg-green-700 py-3 px-6 text-lg md:text-xl h-auto flex items-center space-x-2"
      >
