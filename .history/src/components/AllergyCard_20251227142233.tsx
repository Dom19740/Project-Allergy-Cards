...
const AllergyCard: React.FC<AllergyCardProps> = ({ languageCode, selectedAllergens }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-around w-full bg-white text-foreground p-4 sm:p-8 text-center relative overflow-hidden pb-20 flex-grow">
      ...
      <p className="relative z-10 text-xl sm:text-3xl md:text-4xl font-semibold leading-relaxed text-gray-800 dark:text-gray-200">
      ...
      <button
        onClick={handleShare}
        disabled={isSharing}
        className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-green-600 text-white hover:bg-green-700 px-2 py-1 rounded text-xs font-semibold flex items-center gap-1"
      >
